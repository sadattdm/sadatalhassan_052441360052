...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2026 at 01:22 AM
...
CREATE TABLE `registrations` (
  ...
  `status` enum('pending','approved','dropped') DEFAULT 'approved'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `registrations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_reg` (`user_id`,`course_id`),
